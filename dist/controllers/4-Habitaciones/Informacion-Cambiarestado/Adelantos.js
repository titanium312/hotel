...
exports.Adelanto = exports.ConsultarDeuda = void 0;
const Database_1 = require("../../../db/Database");
const pool = Database_1.Database.connect();
const ConsultarDeuda = async (req, res) => {
    try {
...
const Adelanto = async (req, res) => {
    ...
    `;
      ...
      `;
        ...
        return res.status(200).json({
            success: true,
            message: deudaRestanteCorrecta <= 0
