...
exports.InformacionReserva = void 0;
const Database_1 = require("../../db/Database"); // Asegúrate de importar tu pool de conexiones
const pool = Database_1.Database.connect();
class InformacionReserva {
    ...
    static async obtenerDetallesReserva(req, res) {
        ...
        try {
            ...
            const [habitacion] = await connection.query(`SELECT
        ...
        WHERE
            ...
            const [reserva] = await connection.query(`SELECT
            r.Fecha_Ingreso,
            r.Fecha_Salida,
        ...
        WHERE
            ...
            const [factura] = await connection.query(`SELECT
...
exports.InformacionReserva = InformacionReserva;
