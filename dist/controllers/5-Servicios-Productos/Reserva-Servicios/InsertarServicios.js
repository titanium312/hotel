...
exports.eliminarServicioDeReserva = exports.insertarServicioAReserva = exports.obtenerServiciosDeReserva = void 0;
const Database_1 = require("../../../db/Database");
const pool = Database_1.Database.connect();
;
// Obtener los servicios asociados a una reserva
const obtenerServiciosDeReserva = async (req, res) => {
    ...
    `, [idReserva]);
        ...
        const serviciosConIdReserva = resultados.map((servicio) => ({
            ...servicio,
...
exports.obtenerServiciosDeReserva = obtenerServiciosDeReserva;
// Insertar un servicio/producto en una reserva
const insertarServicioAReserva = async (req, res) => {
    const { idReserva } = req.params; // Obtener la ID de la reserva desde los parámetros de la URL
...
exports.insertarServicioAReserva = insertarServicioAReserva;
// Eliminar un servicio de la reserva
const eliminarServicioDeReserva = async (req, res) => {
...
exports.eliminarServicioDeReserva = eliminarServicioDeReserva;
