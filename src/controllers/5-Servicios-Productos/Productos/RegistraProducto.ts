    ...
    if (ID_Producto !== undefined && ID_Producto !== null) {
      ...
      const [result] = await connection.execute(
        `UPDATE producto
         ...
         WHERE ID_Producto = ?`,
        [nombre, descripcion, Precio_Unitario, Stock, ID_Provedor, ID_producto_tipo, ID_Unidad, ID_Producto]
      );
      ...
      if (updateResult.affectedRows === 0) {
        ...
        const [insertResult] = await connection.execute(
          `INSERT INTO producto (ID_Producto, Nombre, Descripcion, Precio_Unitario, Stock, ID_Provedor, ID_producto_tipo, ID_Unidad)
           VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
          [ID_Producto, nombre, descripcion, Precio_Unitario, Stock, ID_Provedor, ID_producto_tipo, ID_Unidad]
        );
...
// Obtener provedores
export const getProvedores = async (req: Request, res: Response) => {
  try {
...
export const getProductoTipos = async (req: Request, res: Response) => {
  try {
